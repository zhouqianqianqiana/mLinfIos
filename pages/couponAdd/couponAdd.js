...
var vm = new Vue({
	...
	data: {
		...
		type: {'food_coupon': '菜品', 'discount': '折扣', 'full_minus': '满减'},
...
onReady = function () {
	...
	initDate();
	vm.type_code = vm.couponData.typeCode = api.pageParam.type || 'discount';
}

//提交表单
function submitCoupon(data, call) {
	app.ajax({
		url: app.server.couponAdd,
		data: data,
		beforeSend: function () {
			api.showProgress({
				text: '提交中...',
